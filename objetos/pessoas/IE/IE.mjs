...
export class IEclss {
  ...
  setNumero(numero)
   { if (numero) { this.#numero = numero; return true; } 
   return false; } 
  ...
  setDataRegistro(dataregistro)
   { if (dataregistro instanceof Date) { this.#dataRegistro = dataregistro; return true; }
    return false; }
...
export function IEfunc() {
  ...
  function setPJ(pj)
   { if (pj instanceof PJ || (pj && pj.cnpj)) { dados.pj = pj; return true; }
    return false; } 
...
export const IEjson = {
  ...
  { if (data instanceof Date) { this.dataRegistro = data; return true; } return false; }, 

  getDataRegistro()
   { return this.dataRegistro; }, 

  setPJ(pj) 
  { if (pj instanceof PJ || (pj && pj.cnpj)) { this.pj = pj; return true; }
   return false; }, 
